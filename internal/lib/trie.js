...
class Trie {
  ...
  define (pattern, data) {
    ...
    const node = defineNode(this.root, _pattern.split('/'), this.ignoreCase, data)
...
function defineNode (parent, segments, ignoreCase, data) {
  const segment = segments.shift()
  const child = parseNode(parent, segment, ignoreCase, data)
  ...
  return defineNode(child, segments, ignoreCase, data)
}
...
function parseNode (parent, segment, ignoreCase, data) {
  let _segment = segment
